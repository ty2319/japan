...
(function($) {
    ...
    $.fn.sliders = function(options){
        ...
        var slideWidth = slideList.width();
        var slideHeight = slideList.height();
        ...
        function selectAnimation(){
            slideContent.wrapAll('<div class="loop"></div>');
            slideWrapInner.before('<div class="prev fa fa-chevron-circle-left fa-lg"></div>');
            slideWrapInner.after('<div class="next fa fa-chevron-circle-right fa-lg"></div>');
